...
virt-customize --copy-in ${install_dir}sshd_config:/etc/ssh/sshd_config -a ${image_name}
...
qm set ${build_vm_id} --nameserver ${nameserver} --ostype l26 --sshkeys ${keyfile} --ciuser ${cloud_init_user} --cipassword ${cloud_init_password}
